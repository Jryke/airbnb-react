					...
					<div className="grid sidebar-left">
						...
						<div className="content">
							...
							<div className="grid two">
								{this.state.trips.map((trip, i) => i === 0 ? <Thumbnail info={trip} renderLike={this.renderLike} toggleLike={this.toggleLike} index={i} key={i}/> : null)}
							</div>
							<h2>Past Trips</h2>
							<div className="grid two">
							{this.state.trips.map((place, i) => i === 0 ? null : <Thumbnail info={place} renderLike={this.renderLike} toggleLike={this.toggleLike} index={i} key={i}/>)}
							</div>
						</div>
					</div>
				</div>
